...
ActiveRecord::Schema.define(version: 2020_03_27_231701) do
  ...
  create_table "friendship_requests", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pending_friend_id", "requesting_friend_id"], name: "index_unique_friendship_requests", unique: true
  ...
  create_table "friendships", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["user_id", "friend_id"], name: "index_unique_friendships", unique: true
